...
monitor halt
# Start every boot attempt from a clean hart/debug-module state. Re-running this
# test while a previous Linux instance has satp enabled can otherwise resume
# OpenSBI with stale supervisor/MMU state.
...
printf "Linux Image loaded at 0x80200000, DTB loaded at 0x82200000\n"
printf "Watch UART for Linux boot and initramfs message.\n"
